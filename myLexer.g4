...
CONST_NUMBER : [0-9]+ ('x'|'X')? (('0'..'9') | ('a'..'f') | ('A'..'F') )*;
//decimal عدد اعشاری
...
lexeme : (Undifiend_Tokens | ID| STRING| CONST_NUMBER| Decimal_num
         ...
         | SEMICOLON| COMMA| DOT| BRACKET| BRACKET2| PAREBTISES| ACULAD
         | OPENBRACKET| CLOSEBRACKET| OPENBPARENTISIS| CLOSEPARENTISIS| OPENACULAD| CLOSEACULAD
